...
+ (void *) getIdentityWithUsername:(NSString *) username andPassword:(NSString *) password {
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"testlocal1" ofType:@"ssi"];
